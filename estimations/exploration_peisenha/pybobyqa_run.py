...
moments_obs = pickle.load(open("moments_obs.pkl", "rb"))

# TODO: weighting matrix is availble in this dir, that change woudl be next.
# TODO: Mabye just restrict to firt couple of periods
#weighting_matrix = pickle.load(open("weighting_matrix.pkl", "rb"))
...
np.testing.assert_almost_equal(rslt.f, 4.348054023882938)
