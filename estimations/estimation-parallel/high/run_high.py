...
cols = ["value", "fixed"]
params_start.loc[("disutil_work", "no_kids_f_educ_high"), cols] = [+0.90, False]   
params_start.loc[("disutil_work", "no_kids_p_educ_high"), cols] = [-0.75, False]   
params_start.loc[("disutil_work", "yes_kids_f_educ_high"), cols] = [+1.00, False]
params_start.loc[("disutil_work", "yes_kids_p_educ_high"), cols] = [-0.70, False]
